...
public class OrderPage extends TestBase {
   utility utils = new utility();
    ...
    String countryField = OR.getProperty("countryField");
    String countryName = OR.getProperty("countryName");
    String stateField = OR.getProperty("stateField");
    String stateName = OR.getProperty("stateName");
    ...
    String paymentBtn = OR.getProperty("paymentBtn");
    ...
    public void clickProceedTocheckoutBtn() {
        WebElement proceedTocheckoutButton = driver.findElement(By.xpath(proceedTocheckoutBtn));
        scrollToView(proceedTocheckoutButton);
    ...
    public void selectCountryName(String key) throws Exception {
        driver.findElement(By.id(countryName)).sendKeys(utils.dataFetcher(key));
    }
    ...
    public void clickStateField() {
        driver.findElement(By.id(stateField)).click();
    }
    
    public void selectStateName(String key) throws Exception {
        driver.findElement(By.id(stateName)).sendKeys(utils.dataFetcher(key));
    }
